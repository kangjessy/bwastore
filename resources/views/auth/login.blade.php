                ...
                <div class="row align-items-center row-login">
                    ...
                    menjadi lebih mudah</h2>
                        <form method="POST" class="mt-3" action="{{ route('login') }}">
                            ...
                            <button type="submit" class="btn btn-success btn-block w-75 mt-4 py-2 rounded-pill">
                                Sign In to My Account
                            </button>
                            <a href="{{ route('register') }}" class="btn btn-signup btn-block w-75 mt-3 py-2 rounded-pill">
                                Sign Up
                            </a>
                        </form>
                    </div>
