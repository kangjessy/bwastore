...
@section('content')
    <div class="page-content page-cart">
     ...
     <section class="store-cart">
      <div class="container">
        <div class="row" data-aos="faed-up" data-aos-delay="100">
                    ...
                    <tr>
                      ...
                      <td style="width: 20%;">
                        <form action="{{ route('cart-delete', $cart->id) }}" method="POST">
                          @method('DELETE')
                          @csrf
                            <button type="submit" class="btn btn-remove-cart rounded-pill py-2 px-3">
                              Remove
                            </button>
                        </form>
                      </td>
        ...
        <form action="{{ route('checkout') }}" id="locations" enctype="multipart/form-data" method="POST">
          ...
          <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select v-else class="form-control rounded-pill"></select>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-8 col-md-3">
              <button type="submit" class="btn btn-success rounded-pill py-2 mt-4 btn-block">Checkout Now</button>
            </div>
          </div>
        </form>
